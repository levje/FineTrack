...
EXPID="test_generate_async_"_$(date +"%F-%H_%M_%S")
ALG="SACAuto"
RLHFINTERNPV=300         # Number of seeds per tractogram generated during the RLHF pipeline
MAXEP=1                # Number of RLHF iterations
ORACLENBSTEPS=1         # Number of steps for the oracle
AGENTNBSTEPS=1        # Number of steps for the agent
...
if [ $islocal -eq 1 ]; then
    ...
    AGENTCHECKPOINT="/home/local/USHERBROOKE/levj1404/Documents/FineTrack/data/experiments/TrackToLearnRLHF/1-Pretrain-AntoineOracle-Finetune_2024-06-09-20_55_13/1111/model"
else
