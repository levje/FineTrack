...
from FineTrack.algorithms.td3 import TD3
from FineTrack.experiment.experiment import (
    ...
    add_model_args,
    add_tracking_args)
from FineTrack.experiment.train import (
    add_rl_args,
    FineTrackTraining)
...
class TD3FineTrackTraining(FineTrackTraining):
...
def main():
    ...
    td3_experiment = TD3FineTrackTraining(
        vars(args),
        experiment
    )
    td3_experiment.run()
