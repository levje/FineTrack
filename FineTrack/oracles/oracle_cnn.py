...
from FineTrack.oracles.transformer_oracle import LightningLikeModule, _verify_out_activation_with_data
...
class CnnOracle(LightningLikeModule):
    ...
    def test_step(self, test_batch, batch_idx, histogram_metrics: dict = None):
        ...
        if histogram_metrics is not None:
            ...
            reference = "/home/local/USHERBROOKE/levj1404/Documents/FineTrack/data/datasets/ismrm2015_2mm/fodfs/ismrm2015_fodf.nii.gz"
            # reference = "/home/local/USHERBROOKE/levj1404/Documents/FineTrack/data/datasets/ismrm2015_1mm/fodfs/ismrm2015_fodf.nii.gz"
            # reference = "/home/local/USHERBROOKE/levj1404/Documents/FineTrack/data/datasets/ismrm2015_1mm/scoring_data/t1.nii.gz"
