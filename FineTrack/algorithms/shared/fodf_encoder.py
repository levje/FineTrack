...
class SFWorkingFodfEncoder(nn.Module):
    def __init__(self, in_channels,  *args, **kwargs):
        ...
        self.layers = nn.Sequential(
            ...
            small_downsampling_block(in_channels=128, out_channels=128), # 7x7x7
            ResidualBlock(in_channels=128),
            ResidualBlock(in_channels=128),
            ResidualBlock(in_channels=128),
            ResidualBlock(in_channels=128),

            small_downsampling_block(in_channels=128, out_channels=256), # 5x5x5
            ResidualBlock(in_channels=256),
            ResidualBlock(in_channels=256),
            ResidualBlock(in_channels=256),
            ResidualBlock(in_channels=256),

            small_downsampling_block(in_channels=256, out_channels=512), # 3x3x3
...
class SFWorkingFodfDecoder(nn.Module):
    def __init__(self, out_channels, *args, **kwargs):
        ...
        self.layers = nn.Sequential(
            ...
            ResidualBlock(in_channels=512),
            ResidualBlock(in_channels=512),
            small_upsampling_block(in_channels=512, out_channels=256), # 5x5x5

            ResidualBlock(in_channels=256),
            ResidualBlock(in_channels=256),
            ResidualBlock(in_channels=256),
            ResidualBlock(in_channels=256),
            small_upsampling_block(in_channels=256, out_channels=128), # 7x7x7

            ResidualBlock(in_channels=128),
            ResidualBlock(in_channels=128),
            ResidualBlock(in_channels=128),
            ResidualBlock(in_channels=128),
            conv_t_layer(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=0), # 9x9x9
            nn.ReLU(),
